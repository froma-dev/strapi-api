...
export interface ApiContactLinkContactLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type_link: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiTypeLinkTypeLink extends Struct.CollectionTypeSchema {
...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    videoURL: Schema.Attribute.String & Schema.Attribute.Unique;
  };
}
